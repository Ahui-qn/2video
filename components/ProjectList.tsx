...
import { Folder, Clock, Plus, Search, MoreVertical, Trash2, Link, Loader2, RefreshCw, Users } from 'lucide-react';
        ...
        <div className="flex items-center gap-4">
           {/* Join Input */}
            <div className="flex items-center bg-white/5 border border-white/10 rounded-xl px-2 focus-within:border-[#ccff00] transition-colors h-[42px]">
                ...
                <button 
                    disabled={!inviteCode}
                    onClick={() => { if(onJoin) { onJoin(inviteCode); setInviteCode(''); } }}
